...
import (
	...
	gormDb "march-user/cmd/app/common/gorm"
	graph "march-user/cmd/app/graph/generated"
	"march-user/cmd/app/graph/model"
	"march-user/cmd/app/resolvers"
	userManagementService "march-user/cmd/app/services/user-management"
...
func startGrpcServer(grpcPort string) {
	...
	pb.RegisterUserGrpcServiceServer(grpcServer, &userManagementService.Server{})
...
func main() {
	...
	port := os.Getenv("PORT")
	grpcPort := viper.GetString("user.grpc.port")
